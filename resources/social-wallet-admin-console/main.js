...
var app = function () {
    ...
    self.project = function(){ return("Social Wallet :: admin console")}; // ko.observable("no project");
    ...
    var setBlankWorksheet = function () {
        ...
        ws.segments().push(
            ...
            freeSegment("# social-wallet-admin-console\n\n Welcome :-)\n\nShift + Enter will execute code. " +
    ...
    self.title = ko.computed(function () {
        if (self.filename() === "") return "REPL - " + self.project();
